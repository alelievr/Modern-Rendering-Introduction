...
fn main() -> ExitCode {
    if !Path::new("D:\\GitHub\\Modern-Rendering-Introduction\\ModernRendering\\bunny.meshlet_mesh").exists() {
...
fn setup(
    ...
    let meshlet_mesh_handle = asset_server.load("D:\\GitHub\\Modern-Rendering-Introduction\\ModernRendering\\bunny.meshlet_mesh");
